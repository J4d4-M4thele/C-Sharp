...
partial class Program
{
    ...
    private static void QueryCategories()
    {
        ...
        //.Include(c => c.Products); //eager (early) loading

        //explicit loading(manual data loading)
        db.ChangeTracker.LazyLoadingEnabled = false;

        Write("Enable eager loading? (Y/N): ");
        bool eagerLoading = (ReadKey().Key == ConsoleKey.Y);//early loading
    ...
    //filter by minmum units per category
    ...
    //finding which products cost more than a price given
